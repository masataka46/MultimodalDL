#!/usr/bin/env python
"""Example code of learning a RGB dataset by the stage1 of Multimodal Deep Learning model.
...
parser = argparse.ArgumentParser(
    description='Learning RGB dataset by the stage1 of Multimodal Deep Learning Model')
...
parser.add_argument('--out', '-o', default='rgb_model',
...
parser.add_argument('--initmodel', default='bvlc_reference_caffenet.caffemodel',
